...
class AnaliticService:
    ...
    async def calculate_competitor_metrics(self, import_id: UUID):
        ...
        pharmacy_avg AS (
            ...
            GROUP BY np.city, np.pharmacy_name
        )
                     
        INSERT INTO competitor_metrics(import_id, city, pharmacy_name, price_index, category, created_at)
        SELECT
            :import_id,
            city,
            pharmacy_name,
    ...
    async def calculate_city_metrics(self, import_id: UUID):
        ...
        INSERT INTO city_metrics(import_id, city, avg_price, price_dispersion, avg_discount, created_at)
        SELECT
            :import_id,
            cs.city,
            cs.avg_price,
